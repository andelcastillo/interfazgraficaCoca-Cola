...
public class Principal extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == miCalculo){
            ...
            Departamento.equals("") || Antiguedad.equals("e")){
                ...
                if(Departamento.equals("Atención al cliente")){
                    ...
                    if(Antiguedad.equals("1 año de servicio")){
                        ...
                        "\n   trabajador de "  + Departamento + " con " + Antiguedad + 
                ...
                if(Departamento.equals("Departamento de Logística")){
                    ...
                    if(Antiguedad.equals("1 año de servicio")){
                        textarea1.setText("\n   El trabajador " + nombreTrabajador + " " + AP + " " + AM + "," +
                        "\n   trabajador del "  + Departamento + " con " + Antiguedad + 
        ...
        if(e.getSource() == miElCreador){
            ...
            JOptionPane.showMessageDialog(null, "Desarrollado por Andrés del Castillo");
